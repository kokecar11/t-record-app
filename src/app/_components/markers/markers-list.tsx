...
export default function Markerlist() {
	...
	return (
		<>
			{data ? null : <Loader />}
			{markers.length > 0 ? (
				<div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 md:my-6 md:grid-cols-3 md:gap-6 lg:grid-cols-4">
				...
				<div className="mt-4 grid h-full place-items-center">
